...
public class SitesViewModel {
  ...
  public SitesViewModel(SiteDao dao) {
    ...
    // exercice 7 : charger les sites depuis la base et lier le résumé.
    //
  ...
  public void ajouterCommand(Site site) {
    // exercice 7 : insérer le site en base (dao.insert) puis l'ajouter à `sites`.
    dao.insert(site);
    sites.add(site);
  }
  ...
  public void supprimerCommand(Site site) {
    // exercice 7 : supprimer le site en base (dao.delete) puis le retirer de `sites`.
